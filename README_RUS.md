...
* Так же в некоторых случаях минификатор может не сработать, если имена ваших переменных, функций или их параметров отличаются от латинских символов, цифр и знаков "_" и "$".
